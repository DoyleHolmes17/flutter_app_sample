...
import 'package:flutter_app1/beranda/beranda_model.dart';
import 'package:flutter_app1/beranda/beranda_gojek_appbar.dart';
import 'dart:async';
import 'dart:io';
...
class _BerandaPageState extends State<BerandaPage> {
  ...
  Future<List<Food>> fetchFood() async {
    ...
    _goFoodFeaturedList.add(
        new Food(title: "Vegetables", image: "assets/images/food_1.jpg"));
    _goFoodFeaturedList.add(
        new Food(title: "Fruit", image: "assets/images/food_2.jpg"));
    _goFoodFeaturedList.add(
        new Food(title: "Sweets", image: "assets/images/food_3.jpg"));
    _goFoodFeaturedList.add(
        new Food(title: "Salt", image: "assets/images/food_5.jpg"));
    _goFoodFeaturedList.add(new Food(
        title: "Junk Food", image: "assets/images/food_4.jpg"));
